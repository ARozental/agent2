...
class Config:
    ...
    batch_size = 100  # How many books/articles/etc per batch.
    node_sizes = [4096, 1024, 4096, 1000, 1000]  # How many nodes to process at a time at each level => todo: change, each here limits the other
