...
def calc_mlm_loss(agent_level, matrices, real_positions, eos_positions, embeddings, labels, num_dummy=0,
                  dummy_logit_bias=None,pndb=None,A1s=None, pndb_lookup_ids=None):
    ...
    return mlm_losses + (rmlm_losses/10), rmlm_losses,reencoded_matrices #rmlm is now the keep same part! it has 0 weight in config and is just for tracking
