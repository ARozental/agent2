...
def train():
    ...
    main_optimizer = torch.optim.Adagrad(main_params, 0.01)
    generator_optimizer = torch.optim.Adagrad(generator_params, 0.01)
    discriminator_optimizer = torch.optim.Adagrad(discriminator_params, 0.01)
